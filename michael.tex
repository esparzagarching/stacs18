...
\begin{theorem}
  ...
  protocol with leader that has at most $14n + 10 + (?)$ \michael{Add
    the number of extra states added to the construction.} states, and
  that computes the predicate $x \geq 2^{2^n}$.
\end{theorem}

\begin{proof}
  Use~\cite[Lemma~6 and~8]{MM82}.\michael{To be written.}
\end{proof}
